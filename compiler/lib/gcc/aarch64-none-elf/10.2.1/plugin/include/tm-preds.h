/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/tmp/dgboter/bbs/dsggnu-vm-1-x86_64--mingw32-i686/buildbot/mingw32-i686--aarch64-none-elf/build/src/gcc/gcc/config/aarch64/aarch64.md'.  */
